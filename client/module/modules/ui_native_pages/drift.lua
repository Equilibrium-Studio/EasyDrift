function Modules.UI.DisplayDrift()
    ...
    Modules.UI.DrawTexts(0.51041668653488, 0.89999997615814, tostring(Modules.Utils.Comma_value(Modules.DriftCounter.CurrentPoints)) .." ~c~PTS", true, 0.8, {250, 224, 64, alphaToUse}, 6, false, false)
