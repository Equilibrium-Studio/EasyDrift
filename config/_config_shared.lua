...
ConfigShared.AddPointBasedOnAngle = false -- Add an angle based point every frame when the player is drifting. The more angle the player take, the more point he will get